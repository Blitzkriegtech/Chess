...
module HowToPlay
  ...
  def self.instructions
    ...
    En Passant: If an opponent's pawn has just moved two squares forward and is now beside your pawn, you can capture it using the standard diagonal pawn capture move to the square the opponent's pawn skipped over. 
    The game will handle removing the captured pawn correctly.
